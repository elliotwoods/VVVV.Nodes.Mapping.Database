...
namespace VVVV.Nodes.Mapping.Database
{
	class CalibrationSet
	{
		...
		public Matrix4x4 Projection
		{
			get
			{
				return FIntrinsics.Matrix * VMath.Scale(2.0 / (double)FIntrinsics.SensorSize.Width, -2.0 / (double)FIntrinsics.SensorSize.Height, 1.0) *VMath.Translate(-1.0, 1.0, 0.0);
			}
		}
